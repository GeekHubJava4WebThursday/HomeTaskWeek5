...
public class Translator {
     ...
     */
    private static final String YANDEX_API_KEY = "trnsl.1.1.20151113T135952Z.f8a725e42f832b97.98365415a0aceb25f219956f903351ad77c7a9a9";
    ...
    public String translate(String original) throws IOException {
        if(original.isEmpty()) {
            throw new IOException("Loaded file is empty");
        } else {
    ...
    private String encodeText(String text) {
        try {
            return URLEncoder.encode(text, SourceProvider.ENCODING);
